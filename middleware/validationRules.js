...
exports.rules = [
    ...
    check("opinion").not().isEmpty().withMessage("Debe colocar una opinión del destino").isLength({max:150, min:5}).withMessage("La opinión debe contener entre 6 y 149 caracteres")
];
