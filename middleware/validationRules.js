...
exports.rules = [
    ...
    check("opinion").not().isEmpty().withMessage("Debe colocar una opinión del destino").isLength({max:300, min:5}).withMessage("La opinión debe contener entre 6 y 299 caracteres")
];
